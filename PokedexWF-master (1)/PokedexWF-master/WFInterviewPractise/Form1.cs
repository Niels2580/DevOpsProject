...
namespace WFInterviewPractise
{
    public partial class Pokedex : Form
    {
        ...
        {
            string csvfile = @"C:\Users\niels\Downloads\PokedexWF-master (1)\PokedexWF-master\WFInterviewPractise\result.csv";
            string schijding = ",";
            ...
            tester.Append(pokemonEntity.id.ToString());
            tester.Append(schijding);
            tester.Append(pokemonEntity.name.ToString());
            tester.Append(schijding);
            tester.Append(pokemonEntity.capture_rate.ToString());
            tester.Append("\n");
           
            
            
            File.AppendAllText(csvfile, tester.ToString());
